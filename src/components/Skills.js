...
export default function Skills () {
    return (
        <div className='skills-container'>
            <h1>Skills</h1>
                <h2>Proficient</h2>
                <div className='proficient-icons'>
               ...
               <img data-aos='fade-right' src="https://seeklogo.com/images/S/sequelize-logo-9A5075DB9F-seeklogo.com.png" alt=""/>
                <img data-aos='fade-right' src='https://seeklogo.com/images/N/nodejs-logo-FBE122E377-seeklogo.com.png' alt='nodejs'/>
            </div>
            <br/>
